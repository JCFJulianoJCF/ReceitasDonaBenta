  ...
  return (
    <KeyboardView>
      ...
      <Container>
        ...
        secureTextEntry
        />
        <ButtonSubmit mode="contained" onPress={() => navigation.navigate('Receitas Fodas')}>
      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <ScrollView>
          ...
          <RecipesPattern
            ...
            title="Bolo de Milho da Ana Maria Braga"https
          >
